    ...
    categories: [
      {
        ...
        score: 93.2,
        indicators: [
          { name: '필수 항목 완전성', score: 98.7 },
          { name: '선택 항목 완전성', score: 94.1 },
          { name: '레코드 완전성', score: 87.3 },
          { name: '시간 완전성', score: 91.8 },
          { name: '인구통계 완전성', score: 96.5 },
          { name: '진단 정보 완전성', score: 82.4 },
          { name: '처방 정보 완전성', score: 93.0 },
          { name: '검사 결과 완전성', score: 88.9 },
          { name: '종합 완전성', score: 95.8 },
        ],
      },
      {
        name: '정확성',
        score: 90.4,
        indicators: [
          { name: '데이터 형식 정확성', score: 95.6 },
          { name: '값 범위 정확성', score: 89.2 },
          { name: '코드 정확성', score: 84.7 },
          { name: '날짜 정확성', score: 91.3 },
          { name: '수치 정확성', score: 87.5 },
          { name: '참조 무결성', score: 97.2 },
          { name: '논리적 일관성', score: 86.1 },
          { name: '표준 준수율', score: 92.8 },
          { name: '종합 정확성', score: 90.0 },
        ],
      },
      {
        name: '일관성',
        score: 91.2,
        indicators: [
          { name: '시간적 일관성', score: 94.3 },
          { name: '데이터 간 일관성', score: 88.6 },
          { name: '형식 일관성', score: 96.1 },
          { name: '코드 일관성', score: 83.9 },
          { name: '중복 데이터 제거율', score: 90.7 },
          { name: '용어 일관성', score: 85.2 },
          { name: '단위 일관성', score: 93.5 },
          { name: '참조 일관성', score: 89.4 },
          { name: '종합 일관성', score: 92.0 },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        score: 88.9,
        indicators: [
          { name: '필수 항목 완전성', score: 93.2 },
          { name: '선택 항목 완전성', score: 86.4 },
          { name: '레코드 완전성', score: 90.1 },
          { name: '시간 완전성', score: 81.7 },
          { name: '인구통계 완전성', score: 94.8 },
          { name: '진단 정보 완전성', score: 87.9 },
          { name: '처방 정보 완전성', score: 84.3 },
          { name: '검사 결과 완전성', score: 91.6 },
          { name: '종합 완전성', score: 89.0 },
        ],
      },
      {
        name: '정확성',
        score: 85.3,
        indicators: [
          { name: '데이터 형식 정확성', score: 88.1 },
          { name: '값 범위 정확성', score: 82.6 },
          { name: '코드 정확성', score: 86.9 },
          { name: '날짜 정확성', score: 79.4 },
          { name: '수치 정확성', score: 84.0 },
          { name: '참조 무결성', score: 91.2 },
          { name: '논리적 일관성', score: 80.8 },
          { name: '표준 준수율', score: 87.5 },
          { name: '종합 정확성', score: 85.1 },
        ],
      },
      {
        name: '일관성',
        score: 86.2,
        indicators: [
          { name: '시간적 일관성', score: 89.7 },
          { name: '데이터 간 일관성', score: 83.1 },
          { name: '형식 일관성', score: 92.4 },
          { name: '코드 일관성', score: 81.5 },
          { name: '중복 데이터 제거율', score: 88.0 },
          { name: '용어 일관성', score: 78.9 },
          { name: '단위 일관성', score: 90.3 },
          { name: '참조 일관성', score: 85.6 },
          { name: '종합 일관성', score: 86.4 },
        ],
      },
    ],
  },
